...
const social = [
  {
    ...
    height: "28",
    fill: "#D1C9BA",
    type: "bi bi-instagram",
    viewBox: "0 0 16 16",
    href: "https://www.instagram.com/emirgelp/",
    path1:
  ...
  },
  {
    ...
    height: "28",
    fill: "#D1C9BA",
    type: "bi bi-envelope-at",
    viewBox: "0 0 16 16",
    href: "mailto:emiraleconegrete@gmail.com",
    path1:
...
function SocialLinks() {
  return (
    <div>
      {social.map(({ xmlns, type, href, path1, path2 }, index) => {
        return (
            <a href={href} target="blank" key={index}>
              <svg
                xmlns={xmlns}
                width="26"
                height="26"
